...
export const update: Node[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { type: "cmd", id: "up-config-walker", title: "Walker", icon: "magnifying-glass", terminal: true, exec: ["maitri-refresh-walker"] },
  ...
  { type: "cmd", id: "up-extra-themes", title: "Extra Themes", icon: "swatches", terminal: true, exec: ["maitri-theme-update"] },
  {
    ...
    children: [
      ...
      { type: "cmd", id: "up-process-walker", title: "Walker", icon: "magnifying-glass", exec: ["maitri-restart-walker"] },
